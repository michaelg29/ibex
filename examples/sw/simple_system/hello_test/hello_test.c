...
#define ITERS 2
void mul1(int* arr, int ind){
    arr[ind] = 1 + (ind % 7);  // Example pattern: 1.0, 2.0, ..., 10.0, then repeats
}

void mul2(int* arr, int ind){
    arr[ind] = 1 + (ind % 3);  // Example pattern: 1.0, 2.0, ..., 10.0, then repeats
}
